...
export default function CustomShapeBarChart() {
    ...
    return (
        <div className='bg-stone-200 py-10 w-[70%] mx-auto mt-20'>
            {
                readBook.length === 0 ? <h1 className='font-bold text-4xl text-center'>No Books Selected</h1> :
                    (
                        <BarChart className='justify-self-center '
